...
export const SideBar = () => {
  ...
  return (
    <div className = "app-sidebar">
        {/* Cambio a activo si es la direccion actual  */}
        <NavLink to ="/home"  className = { ({ isActive }) =>  `app-sidebar-link ${ isActive ? 'active': '' }` } >
        ...
        <NavLink to = "/ConfigPage"  className = { ({ isActive }) =>  `app-sidebar-link ${ isActive ? 'active': '' }` } >
